      ...
      >
        ...
        <div className="flex gap-3">
          <button
            type="submit"
            disabled={saving}
            className="rounded-full bg-rose-700 px-5 py-2 text-sm font-medium text-white hover:bg-rose-800 disabled:opacity-60"
          >
            ...
            >
              ...
              <div className="flex gap-2 text-sm">
                <button
                  ...
                  className="rounded-full border border-stone-300 px-3 py-1.5 text-stone-700 hover:border-rose-300"
                >
                  Editar
                </button>
                <button
